"""Regression checks for the meridian-net-proxy-pipe casebook."""
...
from casebook.harness import assert_expected, meridian_net_proxy_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_net_proxy_pipe_summary(), assert_expected())
